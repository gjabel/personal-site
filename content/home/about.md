...
My day-to-day research covers estimating migration and applying statistical methods to better forecast components of population change. This website contains posts mainly related to my research using [R](./tags/r/), as well as some information on my [publications](./publication). It is a successor to my [WordPress](http://gjabel.wordpress.com/) site which was blocked in China every now and again.
