---
title: "Animating England Footbal Kits using R"
author: "Guy Abel"
date: '2018-06-01'
tags:
- R
...
Typing `kits` into R will display each kit in the RStudio viewer (it will quickly run through each image). In console displays summary information for each image in the `kits` object.
