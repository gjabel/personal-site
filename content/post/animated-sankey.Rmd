...
header:
  ...
  image: 'headers/sankey-income.png'
  preview: yes
---
...
... so long as you have installed all packages used in the script.
...
<video loop="loop" width="720" height="720" poster="/img/sankey-income/abel-fixed.png" controls>
   <source src="/img/sankey-income/abel-fixed.mp4" type="video/mp4" />
</video>

The final two plots are the same as the first and second, but with an additional origin category for unknown place of birth. The values for the stock of migrants with unknown origins living in each World Bank income group are not in the main data frame in the UN excel sheet, but are in the regional aggregate sheets for each period. As a result the data importing and manipulation takes a bit of extra work (it is commented out in the Gist R script), but the plots are more complete, where the totals of the sectors sum to the global estimate of the UN at each time point. 

<video loop="loop" width="720" height="720" poster="/img/sankey-income/abel-free-unknown.png" controls>
  <source src="/img/sankey-income/abel-free-unknown.mp4" type="video/mp4" />
</video>

... and with a fixed y-axis ... 
<video loop="loop" width="720" height="720" poster="/img/sankey-income/abel-fixed-unknown.png" controls>
