...
...so long as you have installed all packages used in the script. You might also need to edit the `saveVideo()` for the location of `ffmpeg.exe`. 
...
<div id="carousel_fixed" class="carousel slide">
  <!-- Indicators -->
  <ol class="carousel-indicators">
    <li data-target="#carousel_fixed" data-slide-to="0" class="active">Known Origins</li>
    <li data-target="#carousel_fixed" data-slide-to="1">All Origins</li>
  </ol>
  <!-- Wrapper for slides -->
  <div class="carousel-inner">
  <div class="item active">
