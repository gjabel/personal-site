...
Whilst the x-axis scales in each sector are now using fixed units I am not convinced that this is the best way to compare volumes for animated chord diagrams. The sectors of all regions - bar Northern America - are changing places making it hard follow their changes over time. 
